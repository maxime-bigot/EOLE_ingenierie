	...
	<body>
      ...
      <div id="wrap">
        <div id="contenu_page">
				...
				<div class="container">
    				<div class="carousel">
      					<a href="chaufferie/transfo_chaumont.php"><div class="item a" onmouseover="mouseOver('.a')" onmouseout="mouseOut('.a')"><span class="caption">Déplacement transfo Leclerc Chaumont</span></div></a>
      					<a href="chaufferie/chaufferie_chaumont.php"><div class="item b" onmouseover="mouseOver('.b')" onmouseout="mouseOut('.b')"><span class="caption">Rénovation chaufferie Leclerc Chaumont</span></div></a>
      					<a href="chaufferie/chaufferie_stgeosmes.php"><div class="item c" onmouseover="mouseOver('.c')" onmouseout="mouseOut('.c')"><span class="caption">Rénovation chaufferie Leclerc St-Geosmes</span></div></a>
      					<a href="chaufferie/chaufferie_adoma.php"><div class="item d" onmouseover="mouseOver('.d')" onmouseout="mouseOut('.d')"><span class="caption">Rénovation chaufferie ADOMA les oeillets</span></div></a>
   					</div>
  				</div>
