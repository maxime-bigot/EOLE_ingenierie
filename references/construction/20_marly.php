		...
		<div id="bloc_page">
			...
			<div id="contenu_page">
				...
				<div id="cadre">
					<div id="titre">
						<div id="nom">
							<h1>Construction 20 logts Seniors à Marly</h1>
						</div>
					...
					<div id="description">
						<div id="texte">
							<div id="presentation">
								...
								<div id="pres_def">
									<p>
										: OPH MONTIGNY LES METZ </br>
										: M. LACOUR</br>
										(Tél : 03.87.63.58.35)</br>
										: A.C.A. (Architecte)</br>
						...
						<div id="images">
							<a href="javascript:display_photo('../../images/marly1.png','1133','766','Une légende')"><img src="../../images/marly2.png" alt="plan"></a>
						</div>
					</div>
