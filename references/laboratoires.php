...
<html>
	<head>
    	...
    	<link rel="stylesheet" href="../css/laboratoires.css">
	...
	<body>
		<div id="bloc_page">
			...
			<div id="contenu_page">
				...
				<div class="container">
    				<div class="carousel">
      					<a href="laboratoires/arcelor_mines.php"><div class="item a" onmouseover="mouseOver('.a')" onmouseout="mouseOut('.a')"><span class="caption">ArcelorMittal</span></div></a>
      					<a href="laboratoires/arcelor_cpl.php"><div class="item b" onmouseover="mouseOver('.b')" onmouseout="mouseOut('.b')"><span class="caption">ArcelorMittal CPL</span></div></a>
      					<a href="laboratoires/colas.php"><div class="item c" onmouseover="mouseOver('.c')" onmouseout="mouseOut('.c')"><span class="caption">Laboratoires COLAS EST</span></div></a>
   					</div>
  				</div>
